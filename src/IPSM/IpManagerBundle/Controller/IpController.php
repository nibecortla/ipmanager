...
use IPSM\IpManagerBundle\Entity\Ip;
use IPSM\IpManagerBundle\Form\IpType;
...
class IpController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IpManagerBundle:Ip')->findAll();
     ...
     * @Method("POST")
     * @Template("IpManagerBundle:Ip:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IpManagerBundle:Ip')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IpManagerBundle:Ip:edit.html.twig")
     */
