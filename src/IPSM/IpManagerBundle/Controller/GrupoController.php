...
use IPSM\IpManagerBundle\Entity\Grupo;
use IPSM\IpManagerBundle\Form\GrupoType;
...
class GrupoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IpManagerBundle:Grupo')->findAll();
     ...
     * @Method("POST")
     * @Template("IpManagerBundle:Grupo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IpManagerBundle:Grupo')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IpManagerBundle:Grupo:edit.html.twig")
     */
