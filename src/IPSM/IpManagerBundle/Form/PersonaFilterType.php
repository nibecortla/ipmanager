...
class PersonaFilterType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('correo', 'filter_text' , array('condition_pattern' => FilterOperands::STRING_BOTH,))
            ->add('telefono', 'filter_text' , array('condition_pattern' => FilterOperands::STRING_BOTH,))
        ;
    ...
    {
        return 'ipsm_ipmanagerbundle_personafiltertype';
    }
}
